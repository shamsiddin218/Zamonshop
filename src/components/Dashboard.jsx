      ...
      <main className="flex-1 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mb-8">
          {statistikalar.map((item, i) => (
            ...
            >
              <div className="rounded-2xl shadow-md bg-white dark:bg-gray-800 hover:shadow-xl transition p-6">
                <p className="text-gray-600 dark:text-gray-300">{item.title}</p>
                <h3 className="text-2xl font-bold text-blue-600 dark:text-blue-400">{item.value}</h3>
              </div>
            </motion.div>
          ))}
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-md">
          <h3 className="text-xl font-semibold mb-4">Oxirgi 6 oy daromad statistikasi</h3>
