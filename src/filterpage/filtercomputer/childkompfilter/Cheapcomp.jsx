...
export default function Cheapcomp({handleAddToCart}) {
    const cheap = data.Alldata.filter(item => item.category === "Arzon kompyuterlar").sort(()=> 0.5 - Math.random())
