...
export default function Gamecomp({handleAddToCart}) {
      const gamers = data.Alldata.filter(item => item.category === "Geymerlar uchun").sort(()=> 0.5 - Math.random())  
