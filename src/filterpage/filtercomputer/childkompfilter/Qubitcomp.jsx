...
export default function Qubitcomp({handleAddToCart}) {
    const qubit = data.Alldata.filter(item => item.category === "Qubit").sort(()=> 0.5 - Math.random())
