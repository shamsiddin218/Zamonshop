...
export default function Tashqicomp({handleAddToCart}) {
    const qurilma = data.Alldata.filter(item => item.category === "Kompyuterning tashqi qurilmalari").sort(()=> 0.5 - Math.random())
