...
export default function Acercomp({handleAddToCart}) {
    const acercomp = data.Alldata.filter(item => item.category === "Acer").sort(()=> 0.5 - Math.random())
