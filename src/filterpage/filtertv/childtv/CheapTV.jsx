...
export default function CheapTV({handleAddToCart}) {
        const samsung = data.Alldata.filter(item => item.category === "Arzonroq televizorlar").sort(()=> 0.5 - Math.random())
