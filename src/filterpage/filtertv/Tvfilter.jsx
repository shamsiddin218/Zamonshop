   ...
   <div className=" max-w-[1200px] m-auto mb-[44px] px-[10px] mt-[125px]">
               <article className=' w-full flex justify-between items-center'>
                 ...
                 <select value={selectedCategory} onChange={handleCategoryChange} className=' border border-gray-400 bg-transparent  rounded-md outline-none py-[3px] px-[6px]'>
                  ...
                  <option className=' dark:bg-black' value="Smart televizorlar">Smart televizorlar</option>
                  <option className=' dark:bg-black' value="Televizor kabellari">Televizor kabellari</option>
                  <option className=' dark:bg-black' value="Pultlar">Pultlar</option>
                  <option className=' dark:bg-black' value="Arzonroq televizorlar">Arzonroq televizorlar</option>
                  <option className=' dark:bg-black' value="Antena">Antena</option>
                  <option className=' dark:bg-black' value="Tyunerlar">Tyunerlar</option>
                </select>
               </article>
               <article className="w-full grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-[20px] sm:gap-[24px] lg:gap-[30px] gap-y-[30px] mb-[30px]">
                 ...
                 <article key={tvs.id} className="w-full max-w-[270px] m-auto border border-[#80808055] rounded-xl overflow-hidden cursor-pointer transition-all duration-200 relative hover:shadow-md group">
                   ...
                   <article className=" w-full h-[280px] xs:h-[300px] sm:h-[309px] overflow-hidden">
                     <img className="w-full h-full object-cover group-hover:scale-105 transition-all duration-200" src={tvs.image} alt="" />
                   </article>
