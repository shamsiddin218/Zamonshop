...
export default function Gilof({handleAddToCart}) {
    const samsung = data.Alldata.filter(item => item.category === "Planshet giloflari").sort(()=> 0.5 - Math.random())
