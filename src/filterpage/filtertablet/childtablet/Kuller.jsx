...
export default function Kuller({handleAddToCart}) {
    const samsung = data.Alldata.filter(item => item.category === "Sovutgichlar").sort(()=> 0.5 - Math.random())
