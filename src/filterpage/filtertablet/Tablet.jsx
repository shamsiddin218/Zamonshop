...
export default function Tablet({handleAddToCart}) {
  ...
  <div className=" max-w-[1200px] m-auto mb-[44px]">
          ...
          <article className=" w-full grid grid-cols-4 gap-y-[30px] mb-[30px]">
            {tablet.map((tab)=>(
            <article key={tab.id} className=" w-[250px] border border-[#80808055] rounded-xl overflow-hidden cursor-pointer transition-all duration-50 relative hover:shadow-md group">
              ...
              <article className=" w-full h-full p-[5px]">
                ...
                <button onClick={() => setSelectedProduct(tab)} className=" w-full py-[3px] bg-[blue] text-white text-[16px] flex justify-center items-center rounded-[10px]">
