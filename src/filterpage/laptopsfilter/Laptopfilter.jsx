...
export default function Laptopfilter({handleAddToCart}) {
 ...
 <div className=" max-w-[1200px] m-auto mb-[44px] px-[10px] mt-[125px]">
                <article className=' w-full flex justify-between items-center'>
                  ...
                  <option className=' dark:bg-black' value="Lenovo">Lenovo</option>
                  <option className=' dark:bg-black' value="HP">HP</option>
                  <option className=' dark:bg-black' value="Dell">Dell</option>
                  <option className=' dark:bg-black' value="Netbuklar">Netbuklar</option>
                  <option className=' dark:bg-black' value="ASUS">Asus</option>
                  <option className=' dark:bg-black' value="Mac">Mac</option>
                </select>
                </article>
                <article className="w-full grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-[20px] sm:gap-[24px] lg:gap-[30px] gap-y-[30px] mb-[30px]">
                  ...
                  <article key={laptop.id} className="w-full max-w-[270px] m-auto border border-[#80808055] rounded-xl overflow-hidden cursor-pointer transition-all duration-200 relative hover:shadow-md group">
                    ...
                    <article className=" w-full h-full p-[5px]">
                      ...
                      <button onClick={()=>setSelectedProduct(laptop)} className=" w-full py-[6px] sm:py-[8px] bg-blue-600 hover:bg-blue-700 transition-colors duration-150 text-white text-[14px] sm:text-[15px] md:text-[16px] flex justify-center items-center rounded-[10px]">
