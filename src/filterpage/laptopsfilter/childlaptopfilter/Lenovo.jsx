...
export default function Lenovo({handleAddToCart}) {
        const lenovo = data.Alldata.filter(item => item.category === "Lenovo").sort(()=> 0.5 - Math.random())
