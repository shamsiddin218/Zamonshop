...
export default function Tasma({handleAddToCart}) {
        const samsung = data.Alldata.filter(item => item.category === "Tasmalar").sort(()=> 0.5 - Math.random())
