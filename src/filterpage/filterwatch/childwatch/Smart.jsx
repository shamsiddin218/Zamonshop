...
export default function Smart({handleAddToCart}) {
    const samsung = data.Alldata.filter(item => item.category === "Bolalar uchun").sort(()=> 0.5 - Math.random())
