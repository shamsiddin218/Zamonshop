...
export default function Joystik({handleAddToCart}) {
        const joystik = data.Alldata.filter(item => item.category === "Joystiklar").sort(()=> 0.5 - Math.random())
