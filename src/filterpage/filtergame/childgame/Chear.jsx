...
export default function Chear({handleAddToCart}) {
        const chear = data.Alldata.filter(item => item.category === "Orindiqlar").sort(()=> 0.5 - Math.random())
