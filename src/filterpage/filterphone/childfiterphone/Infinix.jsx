...
export default function Infinix({handleAddToCart}) {
    const infinix = data.Alldata.filter(item => item.category === "Infinix").sort(()=> 0.5 - Math.random())
