  ...
  return (
   ...
   <div className=" max-w-[1200px] m-auto mb-[44px]">
                  ...
                  <article className=" w-full grid grid-cols-4 gap-y-[30px] mb-[30px]">
                    ...
                    <article key={texnikas.id} className=" w-[250px] border border-gray-100 rounded-xl overflow-hidden cursor-pointer transition-all duration-50 relative hover:shadow-md group">
