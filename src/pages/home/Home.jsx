      ...
      >
        <SwiperSlide>
          <article className="w-full h-full flex justify-between items-center p-[20px]">
            <article>
              <img className="w-[200px] block dark:hidden" src="/logos/zamonshop_logo_clean.png" alt="logo" />
              <img className=" w-[200px] hidden dark:block" src="/logos/zamonshop_logo_light.png" alt="" />
              <h1 className="text-[42px] font-medium text-blue-950 dark:text-blue-300 mb-[20px]">
                {t('Homepage.title')}
              </h1>
              <p className="text-gray-900 dark:text-gray-200 text-[20px] mb-[20px]">
            ...
            <article>
              <img className="w-[750px]" src="/images/kredit.png" alt="kredit" />
            </article>
          </article>
        </SwiperSlide>
        ...
        <SwiperSlide>
          <article className="w-full bg-gray-200 dark:bg-slate-800 h-full flex justify-between items-center p-[20px]">
            <article>
              <h2 className="text-[42px] font-medium text-gray-900 dark:text-white mb-[30px]">
            ...
            <article>
              <img className="w-[1000px]" src="/images/phonebg.png" alt="phone" />
            </article>
          </article>
        </SwiperSlide>
        ...
        <SwiperSlide>
          <article className="w-full h-full bg-black flex justify-between p-[20px]">
            <article className="flex flex-col justify-center items-start">
              <h2 className="text-white text-[42px] font-medium mb-[30px]">
                {t('Homepage.airtitle')}
              </h2>
              <NavLink to={'/air'}>
            ...
            <article>
              <img className="w-[800px]" src="/images/konditsioner.png" alt="air" />
            </article>
          </article>
        </SwiperSlide>
      </Swiper>
